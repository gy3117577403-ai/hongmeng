...
export default function HomeQualityFixtureShortcut() {
  ...
  return <div className="hm-purchase-shortcut" style={{ marginTop: 10 }}><Link className="hm-purchase-title" href="/workspace/quality-fixtures"><ShieldCheck size={19} /><strong>资料与治具</strong><ArrowUpRight size={15} /></Link>
