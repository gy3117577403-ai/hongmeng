...
export default function EightDArchiveShell({ user }: EightDArchiveShellProps) {
  ...
  return <main className="hm-workbench-root hm-cockpit-root hm-eight-d-workbench">
    ...
    <div className="eight-d-main">
      ...
      <QualityModuleTabs canViewQuick={user.access.capabilities.includes('QUALITY:READ')} active="eight-d" eightDCount={summary.total} canViewData={user.access.capabilities.includes('QUALITY_DATA:READ')} />
