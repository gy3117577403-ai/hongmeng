...
export default function EmployeeQualityWarning({ warning }: { warning: View }) {
  ...
  return <main className="employee-warning"><header><ShieldAlert /><div><small>A级异常 · 已发布归档</small><h1>{qualityEventTitle(warning)}</h1><p>{warning.reportNo} · <b>R{warning.revisionNumber}</b></p></div></header>
