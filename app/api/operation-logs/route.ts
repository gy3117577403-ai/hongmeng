...
const actionGroups: Record<string, string[]> = {
  ...
  connector: [
    ...
    'create_connector_assembly_manual',
    'update_connector_assembly_manual',
    'delete_connector_assembly_manual',
    'restore_connector_assembly_manual',
    'upload_connector_assembly_manual_version',
    'delete_connector_assembly_manual_version',
    'restore_connector_assembly_manual_version',
    'delete_connector_assembly_manual_asset',
    'restore_connector_assembly_manual_asset',
    'mark_connector_assembly_manual_latest',
