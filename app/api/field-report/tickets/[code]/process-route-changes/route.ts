...
export async function POST(
  ...
  try {
    ...
    const created = await createProcessRouteChangeProposal({
      ...
      newTimeBasis: body.newTimeBasis,
      newUnitLabel: body.newUnitLabel,
      newUnitsPerProduct: body.newUnitsPerProduct,
      newReportQuantityBasis: body.newReportQuantityBasis,
      newReportUnitLabel: body.newReportUnitLabel,
