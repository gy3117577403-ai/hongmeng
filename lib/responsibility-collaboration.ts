...
export const responsibilityPeople: ResponsibilityPerson[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      { module: '物料跟进', scope: '仓库发起的物料异常事项', mode: '维护' },
    ],
  },
  {
    ...
    permissions: [
      ...
      { module: '物料跟进', scope: '本人参与的物料异常事项', mode: '查看' },
    ],
  },
  {
  ...
  },
  {
    ...
    flowNames: ['物料跟进', '到料确认'],
    permissions: [
      { module: '物料跟进', scope: '采购承接的物料异常事项', mode: '维护' },
  ...
  },
  {
    ...
    permissions: [
      { module: '物料跟进', scope: '本人协同的跟进事项', mode: '维护' },
...
export const responsibilityMatrix: ResponsibilityMatrixItem[] = [
  ...
  },
  {
    ...
    module: '物料跟进', departmentId: 'procurement', roleKeyword: '采购',
...
export const responsibilityWorkItems: ResponsibilityWorkItem[] = [
  ...
  { id: 'work-17', title: '更新高优缺料预计到料时间', source: '物料跟进', module: '物料跟进', relation: 'owned', priority: 'urgent', dueLabel: '今天 10:00', dateScope: 'today', state: 'processing', stateLabel: '供应跟进', ownerId: 'wang-wei-hong', participantIds: ['jia-gai-zhen', 'ni-jin-dan'], nextPersonId: 'ni-jin-dan', route: '/workspace/procurement', progress: 52 },
  { id: 'work-18', title: '核对供应反馈与仓库签收', source: '物料跟进', module: '物料跟进', relation: 'owned', priority: 'normal', dueLabel: '明天 09:30', dateScope: 'tomorrow', state: 'waiting', stateLabel: '待到料', ownerId: 'jia-gai-zhen', participantIds: ['wang-wei-hong', 'liu-fei'], nextPersonId: 'liu-fei', route: '/workspace/procurement', progress: 44 },
