...
export const sampleMaterialSourceSelect = {
  ...
  sampleQuantity: true, planWeekStartDate: true, dueDate: true, status: true, deletedAt: true, taskType: true, priority: true,
...
export function sampleMaterialSource(task: Source | null | undefined) {
  ...
  return {
    ...
    plannedAt: task?.dueDate || null, deliveryDay: task?.dueDate?.toISOString().slice(0, 10) || null,
