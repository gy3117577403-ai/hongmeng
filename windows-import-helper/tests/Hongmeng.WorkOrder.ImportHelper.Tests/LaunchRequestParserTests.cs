...
public sealed class LaunchRequestParserTests
{
    ...
    public void AcceptsOfficialOriginWithoutTicketInProtocolUrl()
    {
        ...
        var url = $"hongmeng-workorder-import://open?handshakeId={handshakeId}&taskId={taskId}&baseUrl={Uri.EscapeDataString(AppConstants.AllowedWebOrigin)}";
    ...
    {
        var url = $"hongmeng-workorder-import://open?handshakeId={Guid.NewGuid()}&taskId={Guid.NewGuid()}&baseUrl={Uri.EscapeDataString(origin)}";
