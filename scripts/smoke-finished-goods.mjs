...
const print=await call('user',`/workspace/finished-goods/print/${firstShipment.id}`);assert.ok(print.body.includes(firstShipment.number));assert.ok(!print.body.includes('运单：'));
