...
生产版 v1.11.0：账号登录后按工单管理 PDF/JPG/PNG 资料，支持鸿蒙平板拍照上传、浏览器端语音输入、连接器参数资料和资料空态引导。数据存 PostgreSQL，文件存 S3 兼容对象存储，容器重启或重新部署后数据不丢。
...
### RC 说明
- v1.3.0-rc.1、v1.4.0-rc.1、v1.5.0-rc.1、v1.6.0-rc.1、v1.7.0-rc.1、v1.8.0-rc.1、v1.8.0-rc.3、v1.8.0-rc.4、v1.9.0-rc.1、v1.10.0-rc.1、v1.10.0-rc.2、v1.10.0-rc.3、v1.10.0-rc.4、v1.11.0-rc.1 和 v1.12.0-rc.1 为候选版本记录
