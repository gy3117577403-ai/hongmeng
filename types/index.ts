...
export type SampleTaskDTO = {
  ...
  completedQuantityKnown?: boolean;
  unitPlannedMilliseconds?: number | null;
  unitPlannedMinutes?: number | null;
  totalPlannedMilliseconds?: string | null;
  remainingQuantity?: number | null;
  remainingPlannedMilliseconds?: string | null;
  planTimeSource?: string | null;
  sourceOrderLine?: string | null;
  importMutationId?: string | null;
  ...
  stockSummary?: {transferred:number;pending:number;available:number;reserved:number;held:number;blocked:number;shipped:number};
  code: string;
  qrCode: string;
  captureUrl: string;
  drawingLibraryItemId: string;
